class Zahlen {
    ...
    private static String intToText(int x) {
        int ziffern = 0;
        ...
        while(x>0) {
            result.insert(0, (x % 1000 > 0 ? (intToText1000(x % 1000, ziffern) + intToTextDigits(ziffern, x % 1000 > 1)) : ""));
            x = x/1000;
            ziffern = ziffern + 3;
        }
    ...
    public static void main(String[] args) {
        System.out.println(intToText(1212453242));
    }
}